...
export const skillIcons: Record<string, SkillIcon> = {
    ...
    React: { icon: "FaReact", color: "#61DAFB", proficiency: 90 },
    MongoDB: { icon: "SiMongodb", color: "#47A248", proficiency: 70 },
    Render: { icon: "SiRender", color: "#0468D7", proficiency: 60 },
    Python: { icon: "FaPython", color: "#3776AB", proficiency: 95 },
    "Machine Learning": { icon: "SiTensorflow", color: "#FF6F00", proficiency: 80 },
    "Scikit-learn": { icon: "SiScikitlearn", color: "#F7931E", proficiency: 80 },
    Pandas: { icon: "SiPandas", color: "#150458", proficiency: 95 },
    ...
    "C/C++": { icon: "SiCplusplus", color: "#00599C", proficiency: 80 },
    SQL: { icon: "SiMysql", color: "#4479A1", proficiency: 80 },
    "CI/CD Pipelines": { icon: "SiJenkins", color: "#D24939", proficiency: 70 },
    "JavaScript (ES6+)": { icon: "FaJs", color: "#F7DF1E", proficiency: 90 },
    "CSS Frameworks": { icon: "FaCss3Alt", color: "#1572B6", proficiency: 80 },
    "Web Performance Optimization": { icon: "FaRocket", color: "#FF4500", proficiency: 70 },
    ...
    Redis: { icon: "SiRedis", color: "#D82C20", proficiency: 50 },
